...
ACCPGitHubCIStack(app, "accp-ci-linux-arm", LINUX_ARM_ECR_REPO, arm_build_spec_file, env=env)
extra_build_spec_file = "./cdk/codebuild/dieharder_overkill_omnibus.yaml"
ACCPGitHubCIStack(app, "accp-ci-linux-x86", LINUX_X86_ECR_REPO, extra_build_spec_file, env=env)
