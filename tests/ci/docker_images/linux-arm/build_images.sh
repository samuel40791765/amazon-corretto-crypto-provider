...
docker build -t ubuntu-20.04-arm:accp_base ubuntu-20.04_accp_base
...
docker build -t ubuntu-20.04-arm:gcc-7x_corretto -f ubuntu-20.04_gcc-7x_corretto/Dockerfile ../../../../
